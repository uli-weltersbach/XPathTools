...
namespace ReasonCodeExample.XPathTools.Tests.Writers
{
    ...
    public class XPathWriterTests
    {
        ...
        [TestCase("<a xmlns=\"no-prefix\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xlink:w=\"1\" />", "/*[local-name()='a'][namespace-uri()='no-prefix'][@xlink:w='1']/@xlink:w")]
        [TestCase("<a xmlns=\"no-prefix\" xlink:w=\"1\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" />", "/*[local-name()='a'][namespace-uri()='no-prefix'][@xlink:w='1']/@xlink:w")]
